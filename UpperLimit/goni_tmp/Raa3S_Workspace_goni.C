...
void Raa3S_Workspace(const char* name_pbpb="chad_ws_fits/centFits/ws_PbPbData_262548_263757_0cent10_0.0pt50.0_0.0y2.4.root", const char* name_pp="chad_ws_fits/centFits/ws_PPData_262157_262328_-1cent1_0.0pt50.0_0.0y2.4.root", const char* name_out="fitresult_combo.root"){
   ...
   TFile *f = new TFile("fitresult_combo_60_80.root") ;
   ...
   RooFormulaVar nsig3_pp = ws->function("N_{ #varUpsilon(3S)}_pp");
   ...
   RooFormulaVar nsig2_hi = ws->function("N_{ #varUpsilon(2S)}_hi");
   //RooRealVar* nsig2_hi = ws->var("R_{#frac{2S}{1S}}_hi");
   RooAbsReal* nsig3_hi = ws->function("nsig3_hi_modified"); //RooFormulaVar* nsig3_hi = ws->function("nsig3_hi_modified");
   ...
   RooFormulaVar nsig2_pp = ws->function("N_{ #varUpsilon(2S)}_pp");
