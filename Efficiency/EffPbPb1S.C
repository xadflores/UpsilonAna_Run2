...
const int  nPtBin = 5;      // Need to use RapBin for rapidity
...
void EffPbPb1S(){      // Change function name
	...
	TChain myTree("myTree");   // Change source of tree
	myTree.Add("OniaTree_Ups1SMM_5p02TeV_TuneCUETP8M1_ptUps03_noCUT.root");   //  Change tree being added (Different for pp1S, pp2S, PbPb1S, PbPb2S)
        myTree.Add("OniaTree_Ups1SMM_5p02TeV_TuneCUETP8M1_ptUps36_noCUT.root");
	myTree.Add("OniaTree_Ups1SMM_5p02TeV_TuneCUETP8M1_ptUps612_noCUT.root/hionia/myTree");
        myTree.Add("OniaTree_Ups1SMM_5p02TeV_TuneCUETP8M1_ptUps12100_noCUT.root/hionia/myTree");

//        TChain myTree2("hionia/myTree");
//        myTree2.Add("OniaTree_Ups1SMM_5p02TeV_TuneCUETP8M1_ptUps612_noCUT.root");
//	myTree2.Add("OniaTree_Ups1SMM_5p02TeV_TuneCUETP8M1_ptUps12100_noCUT.root");
  ...
  //      myTree.Add(&myTree2);
	...
	Float_t         vProb;
        const int 	test=4;
	double          ptWeight; 
	double          ptWeightArr[test]={3.52395,3.45949,4.35659,1.75768};
	int             centWeight;
	double          ptBin[nPtBin] = {1.25,3.75,6.5,10,21};   //  RapBin
	double          ptBinErr[nPtBin] = {1.25,1.25,1.5,2,9};  // RapBinErr
	Float_t         ptBinEdges[nPtBin+1] = {0,2.5,5.0,8.0,12.0,30.0};
	...
	TH1D  *RecoEvents=new TH1D("RecoEvents","Reconstructed",5, ptBinEdges);

	TH1D  *GenEvents=new TH1D("GenEvents","Generated",5, ptBinEdges);

  	RecoEvents->Sumw2();
        GenEvents->Sumw2();

	TH1D* hEff = new TH1D("Eff", "", 5, ptBinEdges);
...
//         TEfficiency* eEff = new TEfficiency(*RecoEvents, *GenEvents);
//         eEff->SetName("eEff");

//	 hEff->Draw();

/*         hReco_rap_pT_0_30->Sumw2();
         hGen_rap_pT_0_30->Sumw2();
         hEff_rap_pT_0_30->Divide(hReco_rap_pT_0_30, hGen_rap_pT_0_30);

         TEfficiency* eEff_rap_pT_0_30 = new TEfficiency(*hReco_rap_pT_0_30, *hGen_rap_pT_0_30);
         eEff_rap_pT_0_30->SetName("eEff_rap_pT_0_30");


         hReco_rap_pT_30_100->Sumw2();
         hGen_rap_pT_30_100->Sumw2();
         hEff_rap_pT_30_100->Divide(hReco_rap_pT_30_100, hGen_rap_pT_30_100);

         TEfficiency* eEff_rap_pT_30_100 = new TEfficiency(*hReco_rap_pT_30_100, *hGen_rap_pT_30_100);
         eEff_rap_pT_30_100->SetName("eEff_rap_pT_30_100");
*/
...
//  hReco_rap_pT_0_30->Write();
//  hGen_rap_pT_0_30->Write();
//  hEff_rap_pT_0_30->Write();
//  eEff_rap_pT_0_30->Write();

//  hReco_rap_pT_30_100->Write();
//  hGen_rap_pT_30_100->Write();
//  hEff_rap_pT_30_100->Write();
//  eEff_rap_pT_30_100->Write();
...
/* ///////////////
 ...
 TH1D* hRecoAux;// = new TH1D("RecoAux", "", NpTBins, BinspT);
 TH1D* hGenAux;

TGraphAsymmErrors* hEffpp1S = new TGraphAsymmErrors(nPtBin);
hEffpp1S->Draw();


TFile* fppEff1S = new TFile("ppEff1S.root", "Open");
        fppEff1S->GetObject("RecoEvents", hRecoAux);
        fppEff1S->GetObject("GenEvents", hGenAux);

        // now slice - this will get changed for different projections  
//        hRecoAux = hReco_rap_pTAux->ProjectionX("Reco", rapLow, rapHigh);
//        hGenAux = hGen_rap_pTAux->ProjectionX("Gen", rapLow, rapHigh);
        eEffpp1S = new TEfficiency(*hRecoAux, *hGenAux);
        eEffpp1S->SetName("eEffpp1S");
