...
void EffRapPbPb2S(){      // Change function name
...
//  }
//  if (Switch_1S2S == 2){
          MyFileEff = new TFile("RapPbPbEff2S.root", "Recreate");
//  }
//  if (Switch_1S2S == 3){
...
//	TrigEff->SetMarkerColor(2);
	...
	TrigEff->Draw("AP");	// */
	c1->Update();
	c1->SaveAs("EfficiencyVsRapidityUpsilonPbPb2S.png");    // Change output .png name
